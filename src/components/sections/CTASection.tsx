...
const WA_MSG = "Olá! Vim pelo site e gostaria de conversar sobre crédito para meu negócio.";
    ...
    <section className="py-24 bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          style={{
            background: "linear-gradient(135deg, #0f2240 0%, #1e3a5f 50%, #1a4731 100%)",
          }}
        >
          {/* Decorative orbs */}
          <div className="absolute top-0 right-0 w-72 h-72 rounded-full bg-green-500/10 blur-3xl pointer-events-none" />
          <div className="absolute bottom-0 left-0 w-56 h-56 rounded-full bg-blue-400/10 blur-3xl pointer-events-none" />
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/70 text-lg mb-10 max-w-xl mx-auto">
              Entre em contato agora. Nosso atendimento é personalizado, gratuito e sem compromisso.
            </p>
